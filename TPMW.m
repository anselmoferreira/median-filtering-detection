...
%USAGE: TPMW(image_name, class, feat_vec_file_name).
...
function TPMW(image_name, class, feat_vec_file_name)
...
H1=[3 3];
burred_image_1_3x3=medfilt2(image, H1);
[temp_vec]=calculate_IQMs(image, burred_image_1_3x3);
...
burred_image_2_3x3=medfilt2(burred_image_1_3x3, H1);
[temp_vec]=calculate_IQMs(image, burred_image_2_3x3);
...
burred_image_3_3x3=medfilt2(burred_image_2_3x3, H1);
[temp_vec]=calculate_IQMs(image, burred_image_3_3x3);
...
burred_image_1_5x5=medfilt2(image, H2);
[temp_vec]=calculate_IQMs(image, burred_image_1_5x5);
...
burred_image_2_5x5=medfilt2(burred_image_1_5x5, H2);
[temp_vec]=calculate_IQMs(image, burred_image_2_5x5);
...
burred_image_3_5x5=medfilt2(burred_image_2_5x5, H2);
[temp_vec]=calculate_IQMs(image, burred_image_3_5x5);
...
burred_image_1_7x7=medfilt2(image, H3);
[temp_vec]=calculate_IQMs(image, burred_image_1_7x7);
...
burred_image_2_7x7=medfilt2(burred_image_1_7x7, H3);
[temp_vec]=calculate_IQMs(image, burred_image_2_7x7);
...
burred_image_3_7x7=medfilt2(burred_image_2_7x7, H3);
[temp_vec]=calculate_IQMs(image, burred_image_3_7x7);
...
burred_image_1_9x9=medfilt2(image, H4);
[temp_vec]=calculate_IQMs(image, burred_image_1_9x9);
...
burred_image_2_9x9=medfilt2(burred_image_1_9x9, H4);
[temp_vec]=calculate_IQMs(image, burred_image_2_9x9);
...
burred_image_3_9x9=medfilt2(burred_image_2_9x9, H4);
[temp_vec]=calculate_IQMs(image, burred_image_3_9x9);
